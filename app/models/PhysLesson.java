...
@Entity
public class PhysLesson extends AbstractLesson {
    ...
    public static Model.Finder<Integer, PhysLesson> find = new Model.Finder(
            Integer.class, PhysLesson.class
    );

    public List<PhysLesson> all() {
        return find.all();
    }

    public static void clearBase() {
        SqlUpdate rebuildTable = Ebean.createSqlUpdate("TRUNCATE TABLE physlesson");
        try {
    ...
    public static PhysLesson from(PhysLesson from) {
        PhysLesson to = new PhysLesson();
